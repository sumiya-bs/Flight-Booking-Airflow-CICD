...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow_projects_dataengineer")
    bq_project = Variable.get("bq_project", default_var="fit-brand-443118-k1")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "853717367338-compute@developer.gserviceaccount.com",
                "network_uri": "projects/fit-brand-443118-k1/global/networks/default",
                "subnetwork_uri": "projects/fit-brand-443118-k1/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="fit-brand-443118-k1",
        region="us-central1",
